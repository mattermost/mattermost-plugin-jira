		...
		"fields match": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Event:     NewSet("event_created"),
						Project:   NewSet("TES"),
						IssueType: NewSet("10001"),
					},
				},
			}),
		...
		"event type does not match": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Event:     NewSet("event_updated_summary"),
						Project:   NewSet("TES"),
						IssueType: NewSet("10001"),
					},
				},
		...
		"updated all selected": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Event:     NewSet("event_updated_all"),
						Project:   NewSet("TES"),
						IssueType: NewSet("10001"),
					},
				},
		...
		"custom field selected": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Event:     NewSet("event_updated_customfield_10001"),
						Project:   NewSet("TES"),
						IssueType: NewSet("10001"),
					},
				},
		...
		"custom field selected, wrong field": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Event:     NewSet("event_updated_customfield_10002"),
						Project:   NewSet("TES"),
						IssueType: NewSet("10001"),
					},
				},
