...
func TestGetChannelsSubscribed(t *testing.T) {
	...
	for name, tc := range map[string]struct {
		...
		"fields match": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Events:     NewSet("event_created"),
						Projects:   NewSet("TES"),
						IssueTypes: NewSet("10001"),
					},
				},
			}),
		...
		"event type does not match": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Events:     NewSet("event_updated_summary"),
						Projects:   NewSet("TES"),
						IssueTypes: NewSet("10001"),
					},
				},
		...
		"updated all selected": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Events:     NewSet("event_updated_any"),
						Projects:   NewSet("TES"),
						IssueTypes: NewSet("10001"),
					},
				},
		...
		"custom field selected": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Events:     NewSet("event_updated_customfield_10001"),
						Projects:   NewSet("TES"),
						IssueTypes: NewSet("10001"),
					},
				},
		...
		"custom field selected, wrong field": {
			...
			Subs: withExistingChannelSubscriptions([]ChannelSubscription{
				ChannelSubscription{
					...
					ChannelId: "sampleChannelId",
					Filters: SubscriptionFilters{
						Events:     NewSet("event_updated_customfield_10002"),
						Projects:   NewSet("TES"),
						IssueTypes: NewSet("10001"),
					},
				},
		...
		t.Run(name, func(t *testing.T) {
			...
			actual, err := p.getChannelsSubscribed(wh)
			assert.Nil(t, err)
