...
func TestEndpointUnmarshal(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		e.Record(utils.ByteSize(r.Intn(1000*1000*1000)), time.Duration(r.Intn(1000*1000*1000)), false, false)
	}
	estr := e.String()
...
var sample = []struct {
	...
	{100, 100, false, false},
	{120, 110, false, false},
	{1000, 130, false, false},
	{1200, 105, false, true},
	{1200, 105, false, true},
	{5000, 215, true, false},
	{6000, 375, false, true},
	{3250, 145, false, false},
	{33700, 198, false, false},
	{348000, 271, false, false},
	{45603123, 321, false, false},
}
