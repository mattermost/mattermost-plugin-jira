...
func createInstanceCommand(optInstance bool) *model.AutocompleteData {
	...
	uninstall.AddDynamicListArgument("Jira instance", routeAutocomplete+routeAutocompleteInstalledInstance, true)
...
func createConnectCommand() *model.AutocompleteData {
	...
	connect.AddDynamicListArgument("Jira URL", routeAutocomplete+routeAutocompleteConnect, false)
	return connect
}
...
func createAliasCommand() *model.AutocompleteData {
	...
	alias.AddDynamicListArgument("Jira URL", routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias, false)
	return alias
}
...
func createDisconnectCommand() *model.AutocompleteData {
	...
	disconnect.AddDynamicListArgument("Jira URL", routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias, false)
	return disconnect
}
...
func createSettingsCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(notifications, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
...
func createViewCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(view, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
	return view
}
...
func createTransitionCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(transition, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
	return transition
}
...
func createAssignCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(assign, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
	return assign
}
...
func createUnassignCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(unassign, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
	return unassign
}
...
func createSubscribeCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(list, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
...
func createWebhookCommand(optInstance bool) *model.AutocompleteData {
	...
	withFlagInstance(webhook, optInstance, routeAutocomplete+routeAutocompleteInstalledInstanceWithAlias)
	return webhook
}
