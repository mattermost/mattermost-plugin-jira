...
func TestEpicLinkUpdateFormat(t *testing.T) {
	...
	require.Equal(t, w.headline, "Test User **updated** Epic Link from [TES-11](https://some-instance-test.atlassian.net/browse/TES-11) to [TES-12](https://some-instance-test.atlassian.net/browse/TES-12) on story [TES-41: Unit test summary 1](https://some-instance-test.atlassian.net/browse/TES-41)")
}
