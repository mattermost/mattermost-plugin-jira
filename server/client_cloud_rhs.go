...
// rhsBackoffDelay returns the wait after a retryable 429. Prefer parseable
// Retry-After (seconds, >= 0) over exponential backoff; the cap applies to
// both. Then apply jitter.
