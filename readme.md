...
- Whichever hostname you choose, open Mattermost in your browser using that exact URL as mismatches can trigger WebSocket CORS blocks and slash-command errors.
