...
**Support for multiple Jira instances is supported from Jira 3.0 and configured using [Administrator Slash Commands](https://mattermost.gitbook.io/plugin-jira/admininstrator-guide/administrator-slash-commands) (Exclusive to E20 Licensed servers)**
