...
**Support for multiple Jira instances is supported from Jira 3.0 and is configured using [Administrator Slash Commands](https://mattermost.gitbook.io/plugin-jira/administrator-guide/administrator-slash-commands).**
