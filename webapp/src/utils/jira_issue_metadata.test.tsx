...
describe('components/ChannelSettingsInner', () => {
    ...
    test('SERVER should return no options for epic if havent been fetched yet', () => {
        const field = {
            hasDefaultValue: false,
            name: 'Epic Link',
            operations: [
        ...
        const metadata = useField(field, 'customfield_10201');
        const projectKey = metadata.projects[0].key;
    ...
    test('SERVER should return options for epics, if the values have been fetched', () => {
        const field = {
            allowedValues: [
                {id: '10001', name: 'Epic 1'},
            ],
            hasDefaultValue: false,
            name: 'Epic Link',
            operations: [
        ...
        expect(actual[0].key).toEqual('customfield_10201');
        expect(actual[0].values).toEqual([{value: '10001', label: 'Epic 1'}]);
    });
});
