...
export const getProjectValues = memoize((metadata) => {
    if (!metadata) {
        return [];
    }
...
export const getIssueTypes = memoize((metadata, projectKey) => {
...
export const getIssueValues = memoize((metadata, projectKey) => {
...
export const getIssueValuesForMultipleProjects = memoize((metadata, projectKeys) => {
...
export const getFields = memoize((metadata, projectKey, issueTypeId) => {
...
export const getCustomFieldValuesForProjects = memoize((metadata, projectKeys) => {
...
export const getFieldValues = memoize((metadata, projectKey, issueTypeId) => {
